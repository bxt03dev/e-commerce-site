            ...
            <div class="row g-3 fruite">
                <div class="col-12 col-md-3">
                    <div class="row g-4">
                        ...
                        <div class="col-12 d-flex flex-column">
                            <button class="btn border-secondary rounded-pill px-3 py-3  text-uppercase mb-4">
                                Lọc Sản Phẩm
                            </button>
                        </div>
                    </div>
                                    ...
                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                        ...
                                        <div class="d-flex  flex-lg-wrap justify-content-center flex-column">
                                            ...
                                            <form action="/add-product-to-cart/${product.id}"
                                                ...
                                                <button class="mx-auto btn border border-secondary rounded-pill px-3 primary_color">
                                                    <i class="fa fa-shopping-bag me-2 primary_color"></i>
                                                    Add to cart
                                                </button>
                                            </form>
                                        </div>
